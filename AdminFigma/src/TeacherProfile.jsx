...
function TeacherProfile() {
  ...
  const TasodifiyRasmlar = `https://picsum.photos/280/260?random=${Math.floor(Math.random() * 1000)}`;
      ...
      <div className="container flex m-auto">
        <div className="w-[20%] min-h-screen bg-[#152259]">
          ...
          <div className="flex flex-col justify-center items-center gap-2 mt-4">
            ...
            <button onClick={() => navigate("/students")} className="w-[90%] h-10 border border-amber-50 rounded hover:bg-[#509CDB] hover:border-none ">
        ...
        <div className="w-full min-h-screen pt-[30px]">
          ...
          <div className="w-[1041px] h-[601px] m-auto flex justify-center items-center min-h-screen gap-10">
            <div className="w-[50%]">
              <center>
                <img className="rounded-full w-[280px] h-[260px]" src={TasodifiyRasmlar} alt="Random person" />
              </center>
            ...
            <div className="w-[50%]">
              <p><b>About</b> <br />
              <p className="text-[#A7A7A7]">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Numquam quae obcaecati illum, nesciunt laboriosam deleniti mollitia ipsam? Nostrum ea neque eius velit nam pariatur ad iure, unde accusantium dolores aliquam.</p>
              </p>
          ...
          <div className="flex justify-end mr-5 mt-[-160px]">
